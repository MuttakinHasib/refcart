...
const ProductItem = ({ product }) => {
  return (
    <div className='bg-white shadow rounded overflow-hidden group'>
      ...
      <button className='block w-full px-8 py-2 text-center border border-primary bg-primary text-white rounded-b hover:text-primary hover:bg-transparent focus:outline-none transition'>
        Add to cart
      </button>
    </div>
  );
